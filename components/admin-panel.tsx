...
export default function AdminPanel({initialData,adminEmail}:{initialData:any;adminEmail:string}){
 const[data,setData]=useState(initialData||{}),[tab,setTab]=useState("overview"),[reports,setReports]=useState<any[]>([]),[strategies,setStrategies]=useState<any[]>([]),[traders,setTraders]=useState<any[]>([]),[busy,setBusy]=useState(""),[notice,setNotice]=useState(""),[preview,setPreview]=useState<any>(null),[previewBusy,setPreviewBusy]=useState("");
 async function load(){
  ...
  setReports(q.reports||[]);setStrategies(s.strategies||[]);setTraders(t.traders||[]);
 }
 useEffect(()=>{load()},[]);
 ...
 return <div className="admin-frame">
  <aside className="admin-sidebar">
   ...
   <nav className="admin-list-nav">{[
    {k:"overview",l:"Overview",i:BarChart3,b:data.pending_reports},{k:"settlements",l:"Settlements",i:Clock3,b:data.pending_reports},{k:"strategies",l:"Strategies",i:TrendingUp,b:data.strategies},{k:"investors",l:"Investors",i:Users,b:data.investors},{k:"traders",l:"Traders",i:ShieldCheck,b:data.traders},{k:"withdrawals",l:"Withdrawals",i:ArrowDownToLine,b:data.withdrawals_pending},{k:"settings",l:"Settings",i:Settings2}
